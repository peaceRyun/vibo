...
const MoreFilter = ({ onClose }) => {
    ...
    return (
        <FilterContainer>
            <button onClick={onClose} style={{ position: 'absolute', top: '50px', right: '20px' }}>
            ...
            <CategoryList>
                ...
                <CategoryItem
                    onClick={() => handleCategoryClick('크리에이터')}
                    isSelected={selectedCategory === '크리에이터'}
                >
                    크리에이터
                </CategoryItem>
                <CategoryItem
                    onClick={() => handleCategoryClick('관람등급')}
                    isSelected={selectedCategory === '관람등급'}
                >
                    관람등급
                </CategoryItem>
            ...
            {selectedCategory && (
                <ItemList>
                    ...
                    {selectedCategory === '출연' && (
                        <>
                            <Item
                                onClick={() => handleItemClick('프레디 하이모어')}
                                isSelected={selectedItem === '프레디 하이모어'}
                            >
                                프레디 하이모어
                            </Item>
                            ...
                            <Item
                                onClick={() => handleItemClick('리차드 시프')}
                                isSelected={selectedItem === '리차드 시프'}
                            >
                                리차드 시프
                            </Item>
                        </>
                    ...
                    {selectedCategory === '장르' && (
                        <>
                            <Item
                                onClick={() => handleItemClick('메디컬 시리즈')}
                                isSelected={selectedItem === '메디컬 시리즈'}
                            >
                                메디컬 시리즈
                            </Item>
                    ...
                    {selectedCategory === '시리즈 특징' && (
                        <Item
                            onClick={() => handleItemClick('감정을 파고드는')}
                            isSelected={selectedItem === '감정을 파고드는'}
                        >
                            감정을 파고드는
                        </Item>
                    )}
